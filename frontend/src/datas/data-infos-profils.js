const profils = [
  {
    ...
    description:
      "Nicolas est un expert en communication spatiale travaillant pour SpaceMX. Fort d'une expérience de plus de 10 ans dans ce domaine, il est chargé de la planification et de la mise en œuvre des stratégies de communication pour les missions spatiales de l'entreprise. Nicolas a une grande connaissance des technologies de communication utilisées en orbite et de la manière de les exploiter pour transmettre des données, des images et des vidéos depuis l'espace. Grâce à ses compétences en communication, il est capable de maintenir le contact entre les astronautes, les ingénieurs et les scientifiques tout au long des missions spatiales.",
